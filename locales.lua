local locales = {
  ...
  ["esES"] = {
    ...
    ["Display Level+3 Quest Givers"] = "Mostrar dadores de misiones nivel+3",
    ...
    ["Display related objects like ores, herbs, chests, etc."] = "Mostrar objetos como minerales, hierbas, cofres, etc.",
    ...
    ["Draw Favorites On Login"] = "Dibujar favoritos al entrar",
    ...
    ["Show all rare mobs of Level [min] to [max]"] = "Mostrar mobs raros de nivel [min] a [max]",
    ["Show all taxi nodes of [faction]"] = "Mostrar puntos de vuelo de [facción]",
    ["Show Arrow Along Routes"] = "Mostrar flecha a lo largo de rutas",
    ["Show cluster icons with summarized locations and also display all spawn points of each quest objective"] = "Mostrar iconos de grupo con ubicaciones y puntos de aparición",
    ...
    ["Show herbs with an appropriate skill level for your character"] = "Mostrar hierbas según tu nivel de habilidad",
    ["Show herbs with skill range of [min] to [max]"] = "Mostrar hierbas con habilidad de [min] a [max]",
    ...
    ["Show mines with an appropriate skill level for your character"] = "Mostrar minas según tu nivel de habilidad",
    ["Show mines with skill range of [min] to [max]"] = "Mostrar minas con habilidad de [min] a [max]",
    ["Show Navigation Arrow"] = "Mostrar flecha de navegación",
    ["Show navigation arrow that points you to the nearest quest location."] = "Muestra una flecha de navegación al lugar de misión más cercano.",
    ...
    ["Toggle completed quest browser"] = "Ver misiones completadas",
    ...
    ["Use Cut-Out World Map Node Icons"] = "Usar iconos recortados en el mapa",
    ...
    ["Use <Shift>-Click To Mark Quest As Done"] = "Usa <Shift>-Clic para marcar misión como completada",
