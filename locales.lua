local locales = {
  ...
  ["esES"] = {
    ...
    ["Area/Zone"] = "Área/Zona",
    ["Buy"] = "Comprar",
    ["|cff33ffcc<Click>|r Unfold/Fold Objectives\n|cff33ffcc<Right-Click>|r Show In QuestLog\n|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Clic>|r Desplegar/Plegar Objetivos\n|cff33ffcc<Clic Derecho>|r Mostrar en Registro\n|cff33ffcc<Ctrl-Clic>|r Mostrar Mapa / Cambiar Color\n|cff33ffcc<Shift-Clic>|r Ocultar Nodos",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Hide Nodes"] = "|cff33ffcc<Ctrl-Clic>|r Mostrar Mapa / Cambiar Color\n|cff33ffcc<Shift-Clic>|r Ocultar Nodos",
    ["|cff33ffcc<Ctrl-Click>|r Show Map / Toggle Color\n|cff33ffcc<Shift-Click>|r Mark As Done"] = "|cff33ffcc<Ctrl-Clic>|r Mostrar Mapa / Cambiar Color\n|cff33ffcc<Shift-Clic>|r Marcar como Hecho",
    ["|cff33ffccpf|cffffffffQuest: Tracker is now hidden. Type `/db tracker` to show."] = "|cff33ffccpf|cffffffffQuest: El rastreador está oculto. Escribe `/db tracker` para mostrarlo.",
    ["|cff33ffccpf|rQuest: New version available! Have a look at http://shagu.org !"] = "|cff33ffccpf|rQuest: ¡Nueva versión disponible! Visita http://shagu.org",
    ["Clean"] = "Limpiar",
    ["Clean Database Results"] = "Limpiar resultados de la base de datos",
    ["Clean Map"] = "Limpiar mapa",
    ["Chests & Treasures"] = "Cofres y Tesoros",
    ["Click Node To Change Color"] = "Clic en el nodo para cambiar color",
    ["Close"] = "Cerrar",
    ["Close & Reload"] = "Cerrar y recargar",
    ["Close Tracker"] = "Cerrar rastreador",
    ...
    ["Display addon locales"] = "Mostrar traducciones del AddOn",
    ["Display all spawn points of each quest objective and hide summarized cluster icons."] = "Mostrar todos los puntos de aparición de cada objetivo de misión y ocultar iconos de grupo resumidos.",
    ["Display Available Quest Givers"] = "Mostrar dadores de misiones disponibles",
    ...
    ["Display Level+3 Quest Givers"] = "Mostrar dadores de misiones de nivel+3",
    ["Display Low Level Quest Givers"] = "Mostrar dadores de misiones de bajo nivel",
    ["Display related creatures and NPCs"] = "Mostrar criaturas y NPCs relacionados",
    ["Display related items"] = "Mostrar objetos relacionados",
    ["Display related objects like ores, herbs, chests, etc."] = "Mostrar objetos relacionados como minerales, hierbas, cofres, etc.",
    ["Display related quests"] = "Mostrar misiones relacionadas",
    ["Distance"] = "Distancia",
    ["Do you really want to reset everything?"] = "¿Realmente quieres reiniciar todo?",
    ["Do you really want to reset the caches?"] = "¿Realmente quieres reiniciar los cachés?",
    ["Do you really want to reset the configuration?"] = "¿Realmente quieres reiniciar la configuración?",
    ["Do you really want to reset the quest history?"] = "¿Realmente quieres reiniciar el historial de misiones?",
    ["Draw Favorites On Login"] = "Dibujar favoritos al iniciar sesión",
    ["Enable Minimap Button"] = "Activar botón del minimapa",
    ["Enable Minimap Nodes"] = "Activar nodos del minimapa",
    ["Enable Quest Link Support"] = "Activar soporte de enlaces de misiones",
    ["Enable Quest Log Buttons"] = "Activar botones en el registro de misiones",
    ["Enable Quest Tracker"] = "Activar rastreador de misiones",
    ["Enable World Map Menu"] = "Activar menú del mapa del mundo",
    ["Exploration Mark"] = "Marca de exploración",
    ["Explore"] = "Explorar",
    ["Explore |cff33ffcc%s|r"] = "Explorar |cff33ffcc%s|r",
    ["Fishing Pools"] = "Bancos de Pesca",
    ["Flight Master"] = "Maestro de Vuelo",
    ["Friendly"] = "Amistoso",
    ["General"] = "General",
    ["Herbalism"] = "Herboristería",
    ["Herbs & Flowers"] = "Hierbas y Flores",
    ["Hide"] = "Ocultar",
    ["Hide browser window"] = "Ocultar ventana del buscador",
    ["Hide Quests"] = "Ocultar misiones",
    ["Highlight Nodes On Mouseover"] = "Resaltar nodos al pasar el ratón",
    ["Hold <Ctrl> To Hide Cluster"] = "Mantén <Ctrl> para ocultar grupos",
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Mantén <Ctrl> para ocultar nodos del minimapa",
    ["Horde"] = "Horda",
    ["Hostile"] = "Hostil",
    ["Include Quest Enders"] = "Incluir finalizadores de misión",
    ["Include Quest Starters"] = "Incluir iniciadores de misión",
    ...
    ["Interact with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "Interactuar con |cff33ffcc%s|r para completar |cffffcc00[?]|cff33ffcc %s|r",
    ["Interact with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "Interactuar con |cff33ffcc%s|r para obtener |cffffcc00[!]|cff33ffcc %s|r",
      ["Items"] = "Ítems",
    ["Journal"] = "Diario",
    ...
    ["Location"] = "Ubicación",
    ["Loot"] = "Botín",
    ["Loot and/or Use |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Despojar y/o usar |cff33ffcc[%s]|r de |cff33ffcc%s|r",
    ["Loot |cff33ffcc[%s]|r from |cff33ffcc%s|r"] = "Despojar |cff33ffcc[%s]|r de |cff33ffcc%s|r",
    ["Looted from"] = "Despojado de",
    ["Mailbox"] = "Buzón",
    ["Meeting Stones"] = "Piedras de Encuentro",
    ["Manual Selection"] = "Selección manual",
    ["Map & Minimap"] = "Mapa y Minimapa",
    ["Mines & Ores"] = "Minas y Menas",
    ["Minimap Node Transparency"] = "Transparencia de nodos en el minimapa",
    ["Minimum Item Drop Chance"] = "Probabilidad mínima de caída",
    ["Mining"] = "Minería",
    ["Move Button"] = "Mover botón",
    ["N/A"] = "N/A",
    ["Navigation Arrow"] = "Flecha de navegación",
    ["Node Fade Transparency"] = "Transparencia de desvanecimiento de nodo",
    ["Object"] = "Objeto",
      ["Objects"] = "Entorno",
    ["Online Search"] = "Búsqueda en línea",
    ["Only show cluster icons with summarized objective locations based on spawn points"] = "Solo mostrar iconos de grupo con ubicaciones resumidas",
    ["Open Browser"] = "Abrir buscador",
    ["Open Configuration"] = "Abrir configuración",
    ["Open Database Browser"] = "Abrir buscador de base de datos",
    ["Open Settings"] = "Abrir ajustes",
    ["others"] = "otros",
    ["Please select your preferred |cff33ffccpf|cffffffffQuest|r mode:"] = "Por favor, selecciona tu modo preferido de |cff33ffccpf|cffffffffQuest|r:",
    ["Query the server for completed quests"] = "Consultar misiones completadas al servidor",
    ["Quest End"] = "Final de misión",
    ["Quest history migration completed."] = "Migración del historial de misiones completada.",
    ["Questing"] = "Misiones",
    ["Quest Level"] = "Nivel de misión",
    ["Quest Objective Icons (Mini Map)"] = "Iconos de objetivo (Minimapa)",
    ["Quest Objective Icons (World Map)"] = "Iconos de objetivo (Mapa mundial)",
    ["Quest Objective Spawn Points (Mini Map)"] = "Puntos de aparición de objetivos (Minimapa)",
    ["Quest Objective Spawn Points (World Map)"] = "Puntos de aparición de objetivos (Mapa mundial)",
    ["Quests"] = "Misiones",
    ["Quest Start"] = "Inicio de misión",
    ["Quest Tracker Font Size"] = "Tamaño de fuente del rastreador",
    ["Quest Tracker Unfold Objectives"] = "Desplegar objetivos en el rastreador",
    ["Quest Tracker Visibility"] = "Visibilidad del rastreador",
    ["Reaction"] = "Reacción",
    ...
    ["Reset Language"] = "Reiniciar idioma",
    ["Reset Map"] = "Reiniciar mapa",
    ["Reset Quest History"] = "Reiniciar Historial de Misiones",
    ["Respawn"] = "Reaparición",
    ["Rare Mobs"] = "Mobs Raros",
    ["Repair"] = "Reparación",
    ["Right-Click"] = "Clic derecho",
    ["Routes"] = "Rutas",
    ["Scanning server for items..."] = "Escaneando el servidor en busca de objetos...",
    ["Scan the server for custom items"] = "Escanear objetos personalizados del servidor",
    ["Search"] = "Buscar",
    ["Search item vendors"] = "Buscar vendedores de objetos",
    ["Search loot"] = "Buscar botín",
    ["Search object"] = "Buscar objeto",
    ["Search unit"] = "Buscar unidad",
    ["Server scan started..."] = "Escaneo del servidor iniciado...",
    ...
    ["Show all taxi nodes of [faction]"] = "Mostrar todos los puntos de vuelo de [faction]",
    ["Show Arrow Along Routes"] = "Mostrar flecha a lo largo de las rutas",
    ["Show cluster icons with summarized locations and also display all spawn points of each quest objective"] = "Mostrar iconos de grupo con ubicaciones resumidas y puntos de aparición",
    ["Show configuration interface"] = "Mostrar interfaz de configuración",
    ["Show Current Quests"] = "Mostrar misiones actuales",
    ["Show Database IDs"] = "Mostrar IDs de la base de datos",
    ["Show database interface"] = "Mostrar interfaz de la base de datos",
    ["Show Database Results"] = "Mostrar resultados de la base de datos",
    ["Show Help On Tooltips"] = "Mostrar ayuda en descripciones emergentes",
    ["Show herbs with an appropriate skill level for your character"] = "Mostrar hierbas adecuadas para tu nivel de habilidad",
    ...
    ["Show Level On Quest Tracker"] = "Mostrar nivel en el rastreador",
    ["Show map tracker"] = "Mostrar rastreador en el mapa",
    ["Show mines with an appropriate skill level for your character"] = "Mostrar minas adecuadas para tu nivel de habilidad",
    ["Show mines with skill range of [min] to [max]"] = "Mostrar minas con rango de habilidad de [min] a [max]",
    ["Show Navigation Arrow"] = "Mostrar flecha de navegación",
    ["Show navigation arrow that points you to the nearest quest location."] = "Mostrar una flecha de navegación que apunta a la ubicación de misión más cercana.",
    ...
    ["Show Tooltips"] = "Mostrar descripciones emergentes",
    ["Simple Markers"] = "Marcadores simples",
    ["Sold by"] = "Vendido por",
    ...
    ["Toggle completed quest browser"] = "Alternar buscador de misiones completadas",
    ["Too many entries. Results shown"] = "Demasiadas entradas. Resultados mostrados",
    ...
    ["Unit"] = "Unidad",
      ["Units"] = "Unidades",
    ["Use |cff33ffcc%s|r at |cff33ffcc%s|r"] = "Usar |cff33ffcc%s|r en |cff33ffcc%s|r",
    ...
    ["Use <Shift>-Click To Mark Quest As Done"] = "Usa <Shift>-Clic para marcar la misión como completada",
    ["Use <Shift>-Click To Remove Nodes"] = "Usa <Shift>-Clic para eliminar nodos",
    ["Vendor"] = "Vendedor",
    ["Welcome Screen"] = "Pantalla de bienvenida",
    ["World Map Node Transparency"] = "Transparencia de nodos en el mapa mundial",
    ["You already did this quest."] = "Ya has completado esta misión.",
  ...
  ["esES"] = {
    ...
    ["Clean Database Results"] = nil,
    ["Clean Map"] = "Limpiar mapa",
    ["Click Node To Change Color"] = "Click en el nodo para cambiar color",
    ["Close"] = "Cerrar",
    ["Close & Reload"] = "Cerrar y recargar",
    ["Close Tracker"] = "Cerrar rastreador",
    ["Color Map Nodes By Spawn"] = "Colorear nodos del mapa por spawn",
    ...
    ["Config"] = "Configuración",
    ["custom items loaded."] = "objetos personalizados cargados",
    ["Display addon locales"] = "Mostrar locales del addon",
    ["Display all spawn points of each quest objective and hide summarized cluster icons."] = "Mostrar todos los puntos de aparición de cada objetivo y ocultar iconos de grupo.",
    ["Display Available Quest Givers"] = "Mostrar dadores de misiones disponibles",
    ["Display Current Quest Givers"] = "Mostrar dadores de misiones actuales",
    ["Display Event & Daily Quests"] = "Mostrar eventos y misiones diarias",
    ["Display Level+3 Quest Givers"] = nil,
    ...
    ["Herbalism"] = "Herboristería",
    ["Hide"] = "Ocultar",
    ["Hide browser window"] = "Ocultar botones",
    ["Hide Quests"] = "Ocultar misiones",
    ["Highlight Nodes On Mouseover"] = "Resaltar nodos al pasar el ratón",
    ["Hold <Ctrl> To Hide Cluster"] = "Mantén <Ctrl> para ocultar grupos",
    ["Hold <Ctrl> To Hide Minimap Nodes"] = "Mantén <Ctrl> para ocultar nodos",
    ["Horde"] = "Horda",
    ["Hostile"] = "Hostil",
    ["Include Quest Enders"] = "Incluir final de misión",
    ["Include Quest Starters"] = "Incluir inicio de misión",
    ["Include Unified Quest Locations"] = "Incluir loc. unificadas",
    ["Interact with |cff33ffcc%s|r"] = "Interactuar con |cff33ffcc%s|r",
    ["Interact with |cff33ffcc%s|r to complete |cffffcc00[?]|cff33ffcc %s|r"] = "Habla con |cff33ffcc%s|r para completar |cffffcc00[?]|cff33ffcc %s|r",
    ["Interact with |cff33ffcc%s|r to obtain |cffffcc00[!]|cff33ffcc %s|r"] = "Habla con |cff33ffcc%s|r para obtener |cffffcc00[!]|cff33ffcc %s|r",
    ["Items"] = "Objetos",
    ["Journal"] = "Diario",
    ["Kill |cff33ffcc%s|r"] = "Matar a |cff33ffcc%s|r",
    ["Left-Click"] = "Clic izquierdo",
    ...
    ["Manual Selection"] = "Selección manual",
    ["Map & Minimap"] = "Mapa y Minimapa",
    ["Minimap Node Transparency"] = "Transparencia minimapa",
    ["Minimum Item Drop Chance"] = "Probabilidad mínima de caída",
    ["Mining"] = "Minería",
    ["Move Button"] = "Mover botón",
    ["N/A"] = "N/A",
    ...
    ["Objects"] = "Objetos",
    ["Online Search"] = "Búsqueda en línea",
    ["Only show cluster icons with summarized objective locations based on spawn points"] = "Solo mostrar grupos",
    ["Open Browser"] = "Abrir navegador",
    ["Open Configuration"] = "Abrir configuración",
    ["Open Database Browser"] = "Abrir base de datos",
    ["Open Settings"] = "Configuración",
    ["others"] = "otros",
    ["Please select your preferred |cff33ffccpf|cffffffffQuest|r mode:"] = "Selecciona tu modo de |cff33ffccpf|cffffffffQuest|r preferido:",
    ["Query the server for completed quests"] = "Consultar misiones completadas",
    ["Quest End"] = "Misión terminada",
    ["Quest history migration completed."] = "Migración de historia de misiones se ha completada",
    ["Questing"] = "Misiones",
    ["Quest Level"] = "Nivel de misión",
    ["Quest Objective Icons (Mini Map)"] = "Iconos de objetivo (Minimapa)",
    ["Quest Objective Icons (World Map)"] = "Iconos de objetivo (Mapa)",
    ["Quest Objective Spawn Points (Mini Map)"] = "Puntos de aparición (Minimapa)",
    ["Quest Objective Spawn Points (World Map)"] = "Puntos de aparición (Mapa)",
    ["Quests"] = "Misiones",
    ["Quest Start"] = "Empezar misión",
    ["Quest Tracker Font Size"] = "Tamaño fuente rastreador",
    ["Quest Tracker Unfold Objectives"] = "Desplegar objetivos",
    ["Quest Tracker Visibility"] = "Visibilidad del rastreador",
    ["Reaction"] = "Reacción",
    ["Remove all manually searched objects from the map"] = "Limpiar búsquedas del mapa",
    ["Required"] = "Requerida",
    ["Required Level"] = "Nivel requerido",
    ["Reset"] = "Reiniciar",
    ["Reset Cache"] = "Reiniciar caché",
    ...
    ["Reset Language"] = "Reiniciar idioma",
    ["Reset Map"] = "Reiniciar mapa",
    ["Reset Quest History"] = "Reiniciar historial",
    ["Respawn"] = "Reaparición",
    ["Right-Click"] = "Clic derecho",
    ["Routes"] = "Rutas",
    ["Scanning server for items..."] = "Escaneando el servidor por objetos...",
    ["Scan the server for custom items"] = "Escanear objetos personalizados",
    ["Search"] = "Buscar",
